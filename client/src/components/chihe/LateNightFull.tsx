/**
 * LateNightFull Component
 * Complete list of late night food places for the Chihe page
 *
 * Features:
 * - Grid layout with responsive columns
 * - All available late night restaurants
  ...
  if (places.length === 0) {
    return (
      <div className="rounded-lg bg-card/50 border border-border/40 p-8 text-center">
        <p className="text-muted-foreground font-mono">暂无夜宵店推荐</p>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-muted-foreground/80 font-mono">
        湾区夜宵推荐 - 火锅/烧烤/串串 - 共 {places.length} 家
      </div>
