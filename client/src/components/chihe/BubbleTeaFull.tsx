/**
 * BubbleTeaFull Component
 * Complete list of bubble tea shops for the Chihe page
 *
 * Features:
 * - Grid layout with responsive columns
 * - All available milk tea shops
  ...
  if (places.length === 0) {
    return (
      <div className="rounded-lg bg-card/50 border border-border/40 p-8 text-center">
        <p className="text-muted-foreground font-mono">暂无奶茶店推荐</p>
