  ...
  news: [
    {
      ...
      summary_zh: "OpenAI向企业客户开放GPT-5早期访问，性能大幅提升",
    ...
    },
    {
      id: "tech002",
      title: "Meta开始新一轮招聘",
      summary_zh: "Meta计划在湾区招聘500名AI工程师，重点是LLM和推荐系统",
    ...
    },
    {
      id: "tech003",
      title: "英伟达H200芯片供不应求",
      summary_zh: "英伟达最新AI芯片订单排到明年Q3，价格持续上涨",
      why_it_matters_zh: "可能推动AI股票板块上涨，影响科技股投资决策",
      tags: ["芯片", "英伟达", "AI"],
      source: "Reuters",
      url: "https://reuters.com/",
    ...
    {
      id: "tech004",
      title: "亚马逊AWS宣布AI基础设施扩张计划",
      summary_zh: "AWS将在未来两年投资150亿美元建设AI数据中心",
      why_it_matters_zh: "云计算和AI基础设施岗位需求将大幅增加",
      tags: ["云", "AWS", "AI"],
    ...
    {
      id: "tech005",
      title: "微软Q4财报超预期，Azure增长强劲",
      summary_zh: "微软云业务季度营收增长30%，主要由AI服务驱动",
      why_it_matters_zh: "财报表现影响股价和期权价值，云工程师需求旺盛",
      tags: ["财报", "微软", "云"],
      source: "CNBC",
      url: "https://cnbc.com/",
      publishedAt: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
