 ...
 * Fetches real-time stock market data using Manus Data API
 */

import fetch from 'node-fetch';

const DATA_API_URL = process.env.BUILT_IN_FORGE_API_URL || 'https://forge.manus.im';
const DATA_API_KEY = process.env.BUILT_IN_FORGE_API_KEY || '';
